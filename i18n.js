...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'hero.title1': 'Freitagskind',
      'hero.title2': 'Apps',
      'hero.tagline': 'Code as experience,<br/>not just function.',
      'hero.scroll': 'Scroll to explore',
      'row.indexLabel': 'Project',
      'r1.title': 'Pendula',
      'r1.tag': 'Moments, counted.',
      'r1.desc':
      ...
      'r3.cta': 'Get in touch →',
      'foot.copy':
        'freitagskind apps is an independent development studio crafting digital experiences that inspire and empower.',
      'foot.cta': "Let's build something extraordinary together.",
      'foot.contact': 'Contact',
      'foot.copyright': '© 2026 freitagskind apps',
    ...
    de: {
      ...
      'hero.title1': 'Freitagskind',
      'hero.title2': 'Apps',
      'hero.tagline': 'Code als Erlebnis –<br/>nicht nur als Funktion.',
      'hero.scroll': 'Mehr entdecken',
      'row.indexLabel': 'Projekt',
      'r1.title': 'Pendula',
      'r1.tag': 'Momente, die zählen.',
      'r1.desc':
        'Eine Countdown-Widget-App, die deine wichtigsten Momente sichtbar macht und dich motiviert. Von Geburtstagen über Reisen bis zu persönlichen Zielen – bleib verbunden mit dem, was wirklich zählt.',
      'r1.cta': 'Projekt ansehen →',
      'r2.title': 'Unser Handwerk',
      'r2.tag': 'Fokussiert. Bewusst.',
      'r2.desc':
        'Wir entwickeln kleine Apps mit echter Wirkung. Das Problem zuerst, klar im Design, gebaut, um zu bleiben – jedes Pixel hat seinen Platz.',
      'r2.cta': 'Ansatz entdecken →',
      'r3.title': 'Das Studio',
      'r3.tag': 'Unabhängig. Mit Haltung.',
      'r3.desc':
        'freitagskind apps ist ein unabhängiges Studio, das digitale Erlebnisse mit Sorgfalt entwickelt. Selbstfinanziert, menschenzentriert und ohne Dark Patterns – versprochen.',
      'r3.cta': 'Kontakt aufnehmen →',
      'foot.copy':
        'freitagskind apps ist ein unabhängiges Entwicklungsstudio, das digitale Erlebnisse mit Sorgfalt entwickelt.',
      'foot.cta': 'Lass uns gemeinsam etwas Außergewöhnliches bauen.',
